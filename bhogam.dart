...
class _BhogamState extends State<Bhogam> {
  ...
  DateTime? selectEnglishCalenderDate; // Date of Birth
  ...
  void _submitForm() async {
    ...
    if (selectedId != null) {
      String BhogamIdConText =
          BhogamIdCon.text; // Correctly use the text from the controller
      ...
      try {
        await _firestore.collection('thirdFormSubmissions').add({
          ...
          'Bhogamstartdate': selectBhogamstartdate?.toIso8601String(),
          'EnglishCalenderDate': selectEnglishCalenderDate?.toIso8601String(),
          ...
          'Bhogamdataenteredby':
              BhogamdataenteredbyCon.text // Use the correct ID here
        });
                ...
                child: AbsorbPointer(
                  child: InputField(
                    ...
                    content: selectEnglishCalenderDate != null
                        ? DateFormat.yMd().format(selectEnglishCalenderDate!)
                        : 'Choose a date',
                  ),
                ),
              ),
                ...
                child: AbsorbPointer(
                  child: InputField(
                    ...
                    content: selectBhogamstartdate != null
                        ? DateFormat.yMd().format(selectBhogamstartdate!)
                        : 'Choose a date',
                  ),
                ),
              ),
